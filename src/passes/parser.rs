...
pub enum InnerError {
  ...
  #[diagnostic(code(zu::unsupported_record_index), url(docsrs), help("maybe open a PR"))]
  ...
  #[diagnostic(code(zu::unsupported_inductive_data), url(docsrs), help("maybe open a PR"))]
  ...
  #[diagnostic(code(zu::unsupported_coinductive_data), url(docsrs), help("maybe open a PR"))]
